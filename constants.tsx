...
export const POLICY_DATA: PolicySectionData[] = [
  {
    id: 'introduction',
    ...
    content: (
      <>
        <p className="mb-4">
          Welcome to <strong>HillsBins</strong> ("we," "our," or "us"). We are committed to protecting your personal information and respecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our mobile application (the "App").
        </p>
        <p>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li>
            <span className="font-medium">To Provide Services:</span> Your address details are used to query The Hills Shire Council’s API and retrieve your specific waste collection schedule.
          </li>
          <li>
    ...
    content: (
      <>
        ...
        <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-brand-500 my-4">
          <h4 className="font-semibold text-gray-900 mb-1">A. The Hills Shire Council</h4>
          <p className="text-sm text-gray-600 mb-2">
            The App acts as a third-party interface for residents. When you search for your bin day, your address details (Suburb, Street, House Number) are transmitted to The Hills Shire Council's API to fetch the schedule data. This transmission is necessary for the App’s core functionality.
          </p>
          <p className="text-xs text-gray-500 italic">
            Note: We do not control The Hills Shire Council’s data retention policies. We recommend reviewing their privacy statement for more information on how they handle ratepayer data.
          </p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
            <div className="flex flex-col gap-2">
                <div className="flex items-center gap-2">
                    ...
                    <a href="mailto:sophiekwon.syd@gmail.com" className="text-brand-600 hover:text-brand-800 hover:underline">sophiekwon.syd@gmail.com</a>
                </div>
            </div>
        </div>
      </>
